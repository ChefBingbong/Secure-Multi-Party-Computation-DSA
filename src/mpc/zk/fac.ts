...
export const zkFacCreateProof = (
      ...
      const T = modMultiply(
            [modPow(Q, alpha, Nhat), modPow(pub.Aux.t, r, Nhat)],
            Nhat
      );
...
export const zkFacVerifyProof = (
      ...
      const R = modMultiply(
            [modPow(pub.Aux.s, N0, Nhat), modPow(pub.Aux.t, proof.sigma, Nhat)],
            Nhat
      );
      ...
      return (
            isInIntervalLEpsPlus1RootN(proof.Z1) &&
            isInIntervalLEpsPlus1RootN(proof.Z2)
      );
};
