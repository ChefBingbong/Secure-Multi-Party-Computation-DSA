...
export const createAddressArray = (gGubKeyHash: Uint8Array, gHash: Uint8Array, prefix: Uint8Array): Uint8Array =>
      gatewayScript(gGubKeyHash, gHash).toAddress(prefix);

export const calculatePubKeyScript = (gGubKeyHash: Uint8Array, gHash: Uint8Array): Uint8Array =>
