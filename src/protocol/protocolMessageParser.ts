...
type BroadcastSignReturn =
      | SignBroadcastForRound2JSON
      | SignBroadcastForRound3JSON
      | SignBroadcastForRound4JSON
      | SignBroadcastForRound5JSON;

type BroadcastKeygenReturn =
      | KeygenBroadcastForRound2JSON
      | KeygenBroadcastForRound3JSON
      | KeygenBroadcastForRound4JSON
      | KeygenBroadcastForRound5JSON;

type DirectMessageSignReturnType = SignMessageForRound2JSON | SignMessageForRound3JSON | SignMessageForRound4JSON;
type DirectMessageKeygenReturnType = KeygenDirectMessageForRound4JSON;

type ProtoclBroadcastReturnType = BroadcastSignReturn | BroadcastKeygenReturn;
type ProtoclDirectMessageReturnType = DirectMessageSignReturnType | DirectMessageKeygenReturnType;
